...
ggsave("MDS.png", width = 8, height = 6, dpi = 300)
#------------------------------------------------------------#
...
#Save the volcano plot
ggsave("BCV.png", width = 8, height = 6, dpi = 300)
#----------------------------------#
...
#Save the volcano plot
ggsave("Heatmap_among_treatments.png", width = 8, height = 6, dpi = 300)
#-------------------------------------------------------------#
...
#Save the volcano plot
ggsave("Heatmap_early_vs_later.png", width = 8, height = 6, dpi = 300)
